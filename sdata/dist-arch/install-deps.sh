...
remove_deprecated_dependencies(){
  ...
  local list=()
  list+=(baklava-{microtex,pymyc-aur,oneui4-icons-git})
...
# Keeping it as a reference for any future installer tweaks.
...
metapkgs=(./sdata/dist-arch/baklava-{audio,backlight,basic,fonts-themes,kde,portal,python,screencapture,toolkit,widgets})
metapkgs+=(./sdata/dist-arch/baklava-hyprland)
metapkgs+=(./sdata/dist-arch/baklava-microtex-git)
metapkgs+=(./sdata/dist-arch/baklava-quickshell-git)
metapkgs+=(./sdata/dist-arch/baklava-bibata-modern-classic-bin)
